<template>
	<view class="content">
		...
		<button @click="addUser">新增一个用户</button>
		<button @click="addRegistration">新增一个报名信息</button>
		<button @click="addJob">新增一个职能信息</button>
		<button @click="addProject">新增一个项目信息</button>
		<button @click="addBaseInfo">初始化基本数据</button>
		
		<button @click="checkProject">查看所有项目</button>
		<button @click="checkProjectDetail">查看项目详情</button>
		<button @click="updateRegistration">新增报名信息</button>
		<button @click="publishProject">发布项目信息</button>
	</view>
</template>
<script setup>
	import { ref } from 'vue';
