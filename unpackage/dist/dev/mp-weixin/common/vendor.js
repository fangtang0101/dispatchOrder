...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__715107F",
    appName: "dispatchOrder",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const p = h('{\n    "address": [\n        "127.0.0.1",\n        "192.168.1.5"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**/*.js",\n        "D:/\u8F6F\u4EF6\u5B89\u88C5\u4F4D\u7F6E/HBuilderX.3.4.18.20220630/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), m = h('[{"provider":"aliyun","spaceName":"dispatch-order","spaceId":"7c08afaf-79fb-4498-b2d1-67470fb0d4e2","clientSecret":"HKlm9plNSNT0SbWRPXwQjg==","endpoint":"https://api.bspapp.com"}]') || [];
let _ = "";
try {
  _ = "__UNI__715107F";
} catch (e) {
